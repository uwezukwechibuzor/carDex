...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"uwezukwechibuzor", "carDex", "auction", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Auction_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"uwezukwechibuzor", "carDex", "auction", "auctionID"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_AuctionAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 2}, []string{"uwezukwechibuzor", "carDex", "auction"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Bid_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"uwezukwechibuzor", "carDex", "auction", "bid", "bidID"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_BidAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"uwezukwechibuzor", "carDex", "auction", "bid"}, "", runtime.AssumeColonVerbOpt(true)))
)
