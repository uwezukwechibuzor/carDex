...
export type AuctionMsgCancelBidResponse = object;

export type AuctionMsgFinalizeBidResponse = object;
...
export interface AuctionQueryAllAuctionResponse {
...
/**
 * @title cardex/auction/auction.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/uwezukwechibuzor/carDex/auction/auction
   */
  queryAuctionAll = (
    query?: {
    ...
    this.request<AuctionQueryAllAuctionResponse, RpcStatus>({
      path: `/uwezukwechibuzor/carDex/auction/auction`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/uwezukwechibuzor/carDex/auction/bid/{bidID}
   */
  queryBid = (bidId: string, params: RequestParams = {}) =>
    this.request<AuctionQueryGetBidResponse, RpcStatus>({
      path: `/uwezukwechibuzor/carDex/auction/bid/${bidId}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/uwezukwechibuzor/carDex/auction/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<AuctionQueryParamsResponse, RpcStatus>({
      path: `/uwezukwechibuzor/carDex/auction/params`,
      method: "GET",
      format: "json",
      ...params,
    });
